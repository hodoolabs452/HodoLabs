...
export default function AboutPage() {
  return (
    <div className="flex flex-col min-h-screen">
      {/* Hero Section */}
      <section className="py-16 md:py-24 bg-radial-[at_top] from-indigo-50/50 dark:from-indigo-950/40 via-white dark:via-[#090d16] to-white dark:to-[#090d16] border-b border-slate-100 dark:border-slate-800 transition-colors">
      ...
      {/* Narrative Section */}
      <section className="py-16 md:py-20 bg-white dark:bg-[#090d16] transition-colors">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
            <div className="rounded-2xl border border-indigo-100 dark:border-indigo-900/60 bg-indigo-50/40 dark:bg-indigo-950/30 p-6 sm:p-8 space-y-3 transition-colors">
            ...
            <div className="rounded-2xl border border-violet-100 dark:border-violet-900/60 bg-violet-50/40 dark:bg-violet-950/30 p-6 sm:p-8 space-y-3 transition-colors">
          ...
          <div className="space-y-4 pt-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
              <div className="rounded-xl border border-slate-200/80 dark:border-slate-800 p-5 bg-slate-50/40 dark:bg-[#0c121e] space-y-2 transition-colors">
      ...
      <section className="py-16 bg-slate-50/80 dark:bg-[#070b13] border-t border-slate-100 dark:border-slate-800 transition-colors">
