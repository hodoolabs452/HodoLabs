  ...
  return (
    <footer className="border-t border-slate-200 bg-slate-50/50">
      <div className="mx-auto max-w-7xl px-4 pt-14 pb-12 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-10 md:grid-cols-12">
          ...
          <div className="md:col-span-5 space-y-4">
            ...
            <div className="pt-1">
              <a
                ...
                className="inline-flex items-center gap-2 text-sm font-medium text-slate-700 hover:text-indigo-600 transition-colors"
              >
          ...
          <div className="md:col-span-3 space-y-3">
            ...
            <div className="space-y-2.5 text-sm">
              <a
                ...
                className="inline-flex items-center gap-1.5 font-medium text-indigo-600 hover:text-indigo-700 transition-colors group"
              >
          ...
          <div className="md:col-span-2 space-y-3">
            ...
            <ul className="space-y-2.5 text-sm">
              ...
              <li>
                <Link href="/terms-of-service" className="text-slate-600 hover:text-slate-900 transition-colors">
                  Terms of Service
                </Link>
              </li>
            </ul>
        ...
        {/* Bottom Bar */}
        <div className="mt-12 border-t border-slate-200/80 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
