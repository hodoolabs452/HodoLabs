    ...
    <header
      className={`sticky top-0 z-50 w-full transition-all duration-200 ${
        scrolled
          ...
          : "bg-white/70 backdrop-blur-xs border-b border-slate-100"
      }`}
    >
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex md:hidden">
          <button
            ...
            className="inline-flex items-center justify-center rounded-lg p-2 text-slate-700 hover:bg-slate-100 focus:outline-none focus:ring-2 focus:ring-indigo-500"
      ...
      {/* Mobile Drawer */}
      {isOpen && (
        <div className="md:hidden border-b border-slate-200 bg-white px-4 pt-2 pb-6 shadow-lg animate-in slide-in-from-top-2 duration-200">
