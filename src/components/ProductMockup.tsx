    ...
    <div className="relative rounded-2xl border border-slate-200/90 bg-white shadow-xl shadow-slate-200/50 overflow-hidden">
      ...
      <div className="flex items-center justify-between border-b border-slate-100 bg-slate-50/70 px-5 py-3.5">
        <div className="flex items-center gap-2.5">
          ...
          <span className="text-xs font-semibold text-slate-700">HodoLabs Learn &mdash; Student Platform</span>
        </div>
        <a
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 divide-y lg:divide-y-0 lg:divide-x divide-slate-100">
        ...
        <div className="lg:col-span-4 p-5 bg-slate-50/40 space-y-4">
          <div className="text-xs font-semibold uppercase tracking-wider text-slate-500">
            Platform Modules
          </div>

          <div className="space-y-2">
            <div className="flex items-center gap-3 rounded-lg bg-white border border-indigo-100 p-3 shadow-2xs">
              <div className="flex h-8 w-8 items-center justify-center rounded-md bg-indigo-600 text-white">
                <BookOpen className="h-4 w-4" />
              </div>
              <div>
                <div className="text-xs font-semibold text-slate-900">Curriculum Explorer</div>
                <div className="text-[11px] text-slate-500">MOE, Common Core, CBSE &amp; more</div>
              </div>
            </div>

            <div className="flex items-center gap-3 rounded-lg bg-white border border-slate-200/60 p-3 shadow-2xs">
              <div className="flex h-8 w-8 items-center justify-center rounded-md bg-emerald-600 text-white">
                <Award className="h-4 w-4" />
              </div>
              <div>
                <div className="text-xs font-semibold text-slate-900">Assessment Engine</div>
                <div className="text-[11px] text-slate-500">Timed tests &amp; smart evaluations</div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 rounded-lg bg-white border border-slate-200/60 p-3 shadow-2xs">
              ...
              <div>
                <div className="text-xs font-semibold text-slate-900">Performance Analytics</div>
                <div className="text-[11px] text-slate-500">Diagnostic mastery tracking</div>
              </div>
            </div>
          </div>
        ...
        <div className="lg:col-span-8 p-5 sm:p-7 space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div className="rounded-lg border border-slate-200/70 p-3.5 bg-slate-50/30">
